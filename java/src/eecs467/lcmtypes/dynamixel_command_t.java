...
public final class dynamixel_command_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(eecs467.lcmtypes.dynamixel_command_t.class))
            return 0L;
 
        classes.add(eecs467.lcmtypes.dynamixel_command_t.class);
    ...
    public static eecs467.lcmtypes.dynamixel_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        eecs467.lcmtypes.dynamixel_command_t o = new eecs467.lcmtypes.dynamixel_command_t();
    ...
    public eecs467.lcmtypes.dynamixel_command_t copy()
    {
        eecs467.lcmtypes.dynamixel_command_t outobj = new eecs467.lcmtypes.dynamixel_command_t();
